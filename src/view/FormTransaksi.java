...
String id = UserSession.get_id();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 520, -1, -1));
        ...
        getContentPane().add(btnHapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 630, 150, 35));
        ...
        getContentPane().add(btnSimpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 630, 150, 35));
        getContentPane().add(tJumlah_bayar, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 570, 200, 35));
        getContentPane().add(tTanggal, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 460, 200, 35));
        ...
        getContentPane().add(cbBulan, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 510, 200, 35));

        tNo_Transaki.setFont(new java.awt.Font("Tahoma", 1, 15)); // NOI18N
        tNo_Transaki.setForeground(new java.awt.Color(255, 255, 255));
        tNo_Transaki.setText("Trns000");
        getContentPane().add(tNo_Transaki, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 190, 140, -1));

        tPetugas.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tPetugas.setForeground(new java.awt.Color(255, 255, 255));
        tPetugas.setText("~");
        getContentPane().add(tPetugas, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 390, 100, -1));

        tAngkatan.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tAngkatan.setForeground(new java.awt.Color(255, 255, 255));
        tAngkatan.setText("~");
        getContentPane().add(tAngkatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 350, 100, -1));

        tKelas.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tKelas.setForeground(new java.awt.Color(255, 255, 255));
        tKelas.setText("~");
        getContentPane().add(tKelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 310, 140, -1));

        tNama_siswa.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tNama_siswa.setForeground(new java.awt.Color(255, 255, 255));
        tNama_siswa.setText("~");
        getContentPane().add(tNama_siswa, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 270, 140, -1));

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("Cari Siswa");
        getContentPane().add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 200, -1, -1));
        ...
        getContentPane().add(cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 190, 600, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 240, 710, 150));

        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("Status Bayar");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 400, -1, -1));
        ...
        getContentPane().add(tNama_siswa1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 400, 420, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 440, 710, 160));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 630, 150, 35));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1120, 630, 150, 35));

        tNisn.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        getContentPane().add(tNisn, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, 140, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("~");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 350, 40, -1));

        tId_petugas.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tId_petugas.setForeground(new java.awt.Color(255, 255, 255));
        tId_petugas.setText("~");
        getContentPane().add(tId_petugas, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 390, 40, -1));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("/");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 400, 20, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("/");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 350, 20, -1));

        jLabel14.setFont(new java.awt.Font("Serif", 0, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-calendar-24.png"))); // NOI18N
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 25, 50));

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/icons8-clock-24.png"))); // NOI18N
        getContentPane().add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 30, 36));
        ...
        getContentPane().add(tgl, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 20, 145, 50));

        time.setBackground(new java.awt.Color(255, 255, 255));
        time.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        time.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(time, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 90, 147, 44));

        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Bg Dashboard.png"))); // NOI18N
        getContentPane().add(bg, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -130, 1360, 960));
